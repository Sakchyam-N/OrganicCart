...
<body>
    <div class="container " id="header">
        ...
        <div class="row align-items-center " style="background-color: #f6eddb">
            <div class="col-md-auto align-self-center">
                <a href="{{ url('/') }}" class="text-decoration-none text-dark">
                <img src="{{ url('images/OrganicCartLogo.png') }}" alt="" class="img-responsive" height="100"></a>
            </div>
            <div class="col-md-5 ">
                ...
                <div class="row align-items-start justify-content-around">
                    ...
                    <div class="col-md-2">
                        <button type="btn" class="btn btn-default btn-sm text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" style="color:blue;"
                                class="bi bi-headset" viewBox="0 0 16 16">
                                <path
                                    d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z" />
                            </svg><span></span><br>Customer Service
                        </button>
                    </div>
                    <div class="col-md-2">
                        <button type="btn" class="btn btn-default btn-sm text-center">
        ...
        <div class="col-md-2 left-inforamtion-bar border m-md-3">
            <div class="row">
                <div class="col">
                    ...
                    <a href="{{route('customers.show',['customer' =>Session::get('customer')])}}" class="text-decoration-none"><h6>My Profile</h6></a>
                    <br>
                </div>
            </div>
            <div class="row border-top pt-2">
                <h4 class="text-dark">Orders</h4>
                <a href="{{route('cust.order')}}" class="text-decoration-none"><h6>My Orders</h6></a>
                <a href="{{route('reviews.show',['review'=>Session::get('customerId')])}}" class="text-decoration-none"><h6>MY Reviews</h6></a>
                <br><br>
            </div>
            <div class="row border-top pt-2">
                <h4 class="text-dark">Security</h4>
                <a href="{{route('customers.edit',['customer' =>Session::get('customer')])}}" class="text-decoration-none"><h6>Change Password</h6></a>
