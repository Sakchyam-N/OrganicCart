...
@section('content')
    <div class="container mt-sm-5 border">
        <div class="row border-bottom border-grey pt-sm-3">
            <div class="col">
                <h4 class="text-center">Product Edit Form</h4>
                <br>
            </div>
        </div>
        <div class="row">
            <div class="col form-box">
                <form class="border-top border-grey pt-sm-3" method="POST"
                    ...
                    <div class="form-group row justify-content-center">
                        <label for="imageName" class="col-sm-2 col-form-label">Product Image Name</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="maxOrder" placeholder="Max Order"
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="minOrder" placeholder="Min Order"
                        ...
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="shop"
                                ...
                                @foreach ($shops as $shop)
                                    @if ($shop['user_id'] == Session::get('traderId') && $product['shop_id'] == $shop['id'])
                                        <option value="{{ $shop['id'] }}" selected>{{ $shop['shop_name'] }}</option>
                                    @elseif($shop['user_id'] == Session::get('traderId'))
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <select class="form-select" aria-label="Default select example" name="category"
                                ...
                                <option value="def">Choose Category</option>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <input type="date" id="manufacture" name="manufacture"
                                value="{{ \Carbon\Carbon::parse($product['manufacture_date'])->format('Y-m-d') }}">
                            @error('manufacture')
                                <div class="form-label text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <input type="date" id="expiry" name="expiry"
                                value="{{ \Carbon\Carbon::parse($product->expiry_date)->format('Y-m-d') }}">
                            @error('expiry')
                                <div class="form-label text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                name="description">{{ $product['product_description'] }}</textarea>
                            @error('description')
                                <div class="form-label text-danger">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                name="allergy">{{ $product['allergy_details'] }}</textarea>
                            @error('allergy')
                                <div class="form-label text-danger">
                                    {{ $message }}
                                </div>
